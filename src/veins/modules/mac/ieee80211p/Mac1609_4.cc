...
void Mac1609_4::initialize(int stage) {
	...
	if (stage == 0) {
		...
		statsSentPackets = 0;
		statsReceivedPackets1 = 0;
		statsReceivedBroadcasts1 = 0;
		statsSentPackets1 = 0;
		statsSentAcks = 0;
...
void Mac1609_4::finish() {
	...
	recordScalar("ReceivedUnicastPackets1", statsReceivedPackets1);
	recordScalar("ReceivedBroadcasts1", statsReceivedBroadcasts1);
	...
	recordScalar("SentPackets1", statsSentPackets1);
	...
	recordScalar("totalBusyTime1", statsTotalBusyTime1.dbl());
}
...
void Mac1609_4::channelIdle(bool afterSwitch) {
	...
	statsTotalBusyTime1 += simTime() - lastBusy;
